...
class admin_settings
{
	...
	public function ub_settings()
	{
		...
		$settings = array('ub_enable', 'ub_allow_bbcodes', 'ub_allow_smilies', 'ub_allow_magic_url', 'ub_enable_announcement', 'ub_enable_comments', 'ub_enable_friends_only', 'ub_enable_feed', 'ub_enable_feed_cats', 'ub_enable_feed_stats', 'ub_enable_rating', 'ub_enable_subscriptions');
